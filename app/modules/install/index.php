								...
								if (preg_match('#^http://([а-яa-z0-9_\-\.])+(\.([а-яa-z0-9\/])+)?+$#u', $site)) {
									...
									if (empty($row['setting_value'])) {
										...
										if (empty($data['users_id'])) {
											...
											$db -> query("INSERT INTO `inbox` (`user`, `author`, `text`, `time`) VALUES ('" . $login . "', 'Vantuz', '" . $textpriv . "', '" . time() . "');");
											...
											$db -> query("INSERT INTO news (`title`, `text`, `author`, `time`) VALUES ('Добро пожаловать!', '" . $textnews . "', '" . $login . "', '" . time() . "');");
