...
if (!empty($config['errorlog'])){
	...
	case '403':
		...
		DB::run()->query("INSERT INTO `error` (`error_num`, `error_request`, `error_referer`, `error_username`, `error_ip`, `error_brow`, `error_time`) VALUES (?, ?, ?, ?, ?, ?, ?);", [403, $request_uri, $http_referer, $username, App::getClientIp(), App::getUsername(), SITETIME]);
	...
	############################################################################################
	case '404':
		DB::run()->query("INSERT INTO `error` (`error_num`, `error_request`, `error_referer`, `error_username`, `error_ip`, `error_brow`, `error_time`) VALUES (?, ?, ?, ?, ?, ?, ?);", [404, $request_uri, $http_referer, $username, App::getClientIp(), App::getUsername(), SITETIME]);
