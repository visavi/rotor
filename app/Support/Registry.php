...
class Registry
{
     ...
     *  'days' => int, 'inverse' => bool, 'unit' => ?string]
     ...
     * unit подписывает единицу измерения — рубли у денежных виджетов
     ...
     * глубины графиков. Виджету с иной глубиной достаточно вернуть свой days —
     * подпись на плитке возьмётся из него. Вызывается лениво: маршрутов и переводов в момент
