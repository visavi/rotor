...
@section('content')
	...
	1. Перейдите в директорию /app/views/files, эта директория автоматически генерирует страницы сайта<br>
	...
	5. Теперь попробуйте перейти на созданную станицу, введите в браузере <?= Setting::get('home') ?>/files?page=library<br>
	...
	?&gt;
		...
		Дополнительно можно указать произвольные ключевые слова и описание заполнив переменные Setting::get('keywords') и Setting::get('description')

	<pre class="prettyprint linenums">
	&lt;?php
		Setting::get('keywords')    = 'Ключевые слова';
		//Setting::get('description') =  'Описание страницы';
	?&gt;
	</pre>
	</div>
