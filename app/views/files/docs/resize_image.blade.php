...
Функция ресайза и кэширования уменьшенных копий картинок, проверяет сделана ли миниатюра изображения, если нет, то автоматически уменьшает картинку и сохраняет ее в специальной папке upload/thumbnail.<br />
...
echo resize_image(\'/upload/pictures/\', $data[\'link\'], $config[\'previewsize\'], $data[\'title\']);
 /* Функция вернет уменьшенную картинку <img src="/upload/thumbnail/upload_pictures_1350.jpg" alt="Название"/> */
?>[/code]'));
?>
