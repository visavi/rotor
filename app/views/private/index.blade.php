...
@section('content')
    ...
    if ($messages->isNotEmpty()) {
        ...
        echo '<div>'.App::bbCode($data['text']).'<br>';
            ...
            echo '<a href="#" onclick="return sendComplaint(this)" data-type="'.Inbox::class.' " data-id="' . $data['id'] . '" data-token="' . $_SESSION['token'] . '" rel="nofollow" title="Жалоба"><i class="fa fa-bell text-muted"></i></a>';
            }
