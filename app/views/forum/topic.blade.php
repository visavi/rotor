...
@section('content')
    ...
    @if (is_user())
        @if ($topic->getUser()->id == App::getUserId() && empty($topic['closed']) && App::user('point') >= Setting::get('editforumpoint'))
        ...
        @foreach ($posts as $key=>$data)
            ...
            <div class="b" id="post_{{ $data['id'] }}">
                ...
                <div class="float-right">
                    ...
                    @if ((App::getUserId() == $data['user_id'] && $data['created_at'] + 600 > SITETIME) || $topic['isModer'])
