...
<div class="b">
	<i class="fa fa-pencil"></i> <b><?=profile($post['commblog_author'])?></b> <?=user_title($post['commblog_author'])?> <?=user_online($post['commblog_author'])?> <small>(<?=date_fixed($post['commblog_time'])?>)</small>
</div>
<div>
