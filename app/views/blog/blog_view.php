<a href="/blog">Блоги</a> / <a href="/blog/blog?cid=<?=$blogs['cats_id']?>"><?=$blogs['name']?></a> / <a href="/blog/print?id=<?=$blogs['id']?>">Скачать</a> / <a href="/blog/rss?id=<?=$blogs['id']?>">RSS-лента</a>
...
<?php if (is_admin()): ?>
	<br /> <a href="/admin/blog?act=editblog&amp;cid=<?=$blogs['cats_id']?>&amp;id=<?=$blogs['id']?>">Редактировать</a> /
	<a href="/admin/blog?act=moveblog&amp;cid=<?=$blogs['cats_id']?>&amp;id=<?=$blogs['id']?>">Переместить</a> /
	<a href="/admin/blog?act=delblog&amp;cid=<?=$blogs['cats_id']?>&amp;del=<?=$blogs['id']?>&amp;uid=<?=$_SESSION['token']?>" onclick="return confirm('Вы действительно хотите удалить данную статью?')">Удалить</a>
<?php endif; ?>
<hr />
...
<i class="fa fa-eye"></i> Просмотров: <?=$blogs['read']?><br />
