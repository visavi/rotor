...
$router->map('GET',      '/forum/active/[posts|themes:action]', 'Forum\ActiveController');
$router->map('POST',     '/forum/active/delete', 'Forum\ActiveController@delete');
$router->map('GET',      '/forum/new/[posts|themes:action]', 'Forum\NewController');
...
$router->map('GET|POST', '/down/create', 'Load\DownController@create');
