...
class PaidAdvertController extends AdminController
{
    ...
    public function index(Request $request): string
    {
        ...
        $totals = [];
        foreach (PaidAdvert::PLACES as $placeName) {
        ...
        return view('admin/paid-adverts/index', compact('adverts', 'place', 'totals'));
    }
    ...
    public function create(Request $request, Validator $validator): string
    {
        ...
        if ($request->isMethod('post')) {
            ...
            foreach ($names as $name) {
                $validator->length($name, 5, 35, ['name' => __('validator.text')]);
            }
            ...
            if ($validator->isValid()) {
                ...
                PaidAdvert::query()->create([
                    ...
                    'bold'       => $bold,
                    'created_at' => SITETIME,
                    'deleted_at' => strtotime('+100 hours', SITETIME),
                ]);
