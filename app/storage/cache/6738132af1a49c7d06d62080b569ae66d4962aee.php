<?php $__env->startSection('title', e($topics['topics_title']).' - @parent'); ?>

<?php $__env->startSection('content'); ?>

    <h1><?php echo e($topics['topics_title']); ?></h1>
    ...
    <?php if (is_user()): ?>
        ...
        / <a href="#" onclick="return bookmark(this)" data-tid="<?php echo e($tid); ?>" data-token="<?php echo e($_SESSION['token']); ?>"><?php echo e($bookmark); ?></a>
    <?php endif; ?>
            ...
            <div class="b" id="post_<?=$data['posts_id']?>">
                ...
                <div class="pull-right">
                    <?php if (!empty($log) && $log != $data['posts_user']): ?>
                        ...
                        <noindex>
                            <a href="#" onclick="return sendComplaint(this)" data-type="/topic" data-id="<?php echo e($data['posts_id']); ?>" data-token="<?php echo e($_SESSION['token']); ?>" data-page="<?php echo e($start); ?>" rel="nofollow" title="Жалоба"><i class="fa fa-bell text-muted"></i></a>
                        </noindex>
