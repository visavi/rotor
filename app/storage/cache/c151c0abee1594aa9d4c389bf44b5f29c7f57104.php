<?php $__env->startSection('title', 'Анкета пользователя '.e($user['users_login']).'. - @parent'); ?>

<?php $__env->startSection('content'); ?>

    <h1><?php echo user_avatars($user['users_login']).nickname($user['users_login']); ?><small><?php echo e(user_visit($user['users_login'])); ?></small></h1>
