...
DB::run()->exec("UPDATE `banhist` SET `ban_reason`= REPLACE(`ban_reason`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `ban_reason` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `blogs` SET `blogs_text`= REPLACE(`blogs_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `blogs_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `chat` SET `chat_text`= REPLACE(`chat_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `chat_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `commblog` SET `commblog_text`= REPLACE(`commblog_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `commblog_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `commevents` SET `commevent_text`= REPLACE(`commevent_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `commevent_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `commload` SET `commload_text`= REPLACE(`commload_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `commload_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `commnews` SET `commnews_text`= REPLACE(`commnews_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `commnews_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `commoffers` SET `comm_text`= REPLACE(`comm_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `comm_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `commphoto` SET `commphoto_text`= REPLACE(`commphoto_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `commphoto_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `downs` SET `downs_text`= REPLACE(`downs_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `downs_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `events` SET `event_text`= REPLACE(`event_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `event_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `guest` SET `guest_text`= REPLACE(`guest_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `guest_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `guest` SET `guest_reply`= REPLACE(`guest_reply`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `guest_reply` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `inbox` SET `inbox_text`= REPLACE(`inbox_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `inbox_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `news` SET `news_text`= REPLACE(`news_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `news_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `note` SET `note_text`= REPLACE(`note_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `note_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `notebook` SET `note_text`= REPLACE(`note_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `note_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `offers` SET `offers_text`= REPLACE(`offers_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `offers_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `offers` SET `offers_text_reply`= REPLACE(`offers_text_reply`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `offers_text_reply` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `outbox` SET `outbox_text`= REPLACE(`outbox_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `outbox_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `photo` SET `photo_text`= REPLACE(`photo_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `photo_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `posts` SET `posts_text`= REPLACE(`posts_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `posts_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `rating` SET `rating_text`= REPLACE(`rating_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `rating_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `spam` SET `spam_text`= REPLACE(`spam_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `spam_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `trash` SET `trash_text`= REPLACE(`trash_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `trash_text` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `users` SET `users_info`= REPLACE(`users_info`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `users_info` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `users` SET `users_reasonban`= REPLACE(`users_reasonban`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `users_reasonban` LIKE '%<img src=\"../images/img/%';");
...
DB::run()->exec("UPDATE `wall` SET `wall_text`= REPLACE(`wall_text`, '<img src=\"../images/img/', '<img src=\"/images/img/') WHERE `wall_text` LIKE '%<img src=\"../images/img/%';");
