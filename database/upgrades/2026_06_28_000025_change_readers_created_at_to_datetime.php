...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::table('readers', static fn (Blueprint $table) => $table->dateTime('created_at')->nullable()->change());
    }
    ...
    public function down(): void
    {
        ...
        DB::table('readers')->truncate();
        Schema::table('readers', static fn (Blueprint $table) => $table->integer('created_at')->nullable()->change());
    }
};
