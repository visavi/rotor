...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        $this->addTempColumns('floods', 'dateTime', ['created_at_dt']);
        $this->convert('floods', 'created_at_dt', ['created_at'], static fn ($r) => ['created_at_dt' => $toDt($r->created_at)]);
    ...
    public function down(): void
    {
        ...
        $this->addTempColumns('floods', 'integer', ['created_at_int']);
        $this->convert('floods', 'created_at_int', ['created_at'], static fn ($r) => ['created_at_int' => $toInt($r->created_at)]);
        Schema::table('floods', fn (Blueprint $table) => $table->dropColumn('created_at'));
