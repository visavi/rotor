...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::table('errors', static fn (Blueprint $table) => $table->dateTime('created_at')->nullable()->change());
    }
    ...
    public function down(): void
    {
        ...
        DB::table('errors')->truncate();
        Schema::table('errors', static fn (Blueprint $table) => $table->integer('created_at')->nullable()->change());
    }
};
