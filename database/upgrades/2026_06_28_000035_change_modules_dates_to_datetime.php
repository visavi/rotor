...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        if (Schema::getColumnType('modules', 'created_at') === 'datetime') {
            return;
        }

        $toDt = static fn ($v) => $v ? Date::createFromTimestamp($v, config('app.timezone'))->format('Y-m-d H:i:s') : null;

        $this->addTempColumns('modules', 'dateTime', ['created_at_dt', 'updated_at_dt']);
        $this->convert('modules', 'created_at_dt', ['created_at', 'updated_at'], static fn ($r) => [
    ...
    public function down(): void
    {
        ...
        $this->addTempColumns('modules', 'integer', ['created_at_int', 'updated_at_int']);
        $this->convert('modules', 'created_at_int', ['created_at', 'updated_at'], static fn ($r) => [
