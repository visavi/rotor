...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        $this->addTempColumns('rules', 'dateTime', ['created_at_dt']);
        $this->convert('rules', 'created_at_dt', ['created_at'], static fn ($r) => ['created_at_dt' => $toDt($r->created_at)]);
    ...
    public function down(): void
    {
        ...
        $this->addTempColumns('rules', 'integer', ['created_at_int']);
        $this->convert('rules', 'created_at_int', ['created_at'], static fn ($r) => ['created_at_int' => $toInt($r->created_at)]);
        Schema::table('rules', fn (Blueprint $table) => $table->dropColumn('created_at'));
