...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        $this->addTempColumns('mailings', 'dateTime', ['created_at_dt', 'sent_at_dt']);
        $this->convert('mailings', 'created_at_dt', ['created_at', 'sent_at'], static fn ($r) => [
    ...
    public function down(): void
    {
        ...
        $this->addTempColumns('mailings', 'integer', ['created_at_int', 'sent_at_int']);
        $this->convert('mailings', 'created_at_int', ['created_at', 'sent_at'], static fn ($r) => [
