...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::table('logs', fn (Blueprint $table) => $table->dateTime('created_at_dt')->nullable());
        $this->convert('logs', ['created_at'], static fn ($r) => ['created_at_dt' => $toDt($r->created_at)]);
        Schema::table('logs', function (Blueprint $table) {
            $table->dropIndex(['created_at']);
            $table->dropColumn('created_at');
        });
        Schema::table('logs', fn (Blueprint $table) => $table->renameColumn('created_at_dt', 'created_at'));
        Schema::table('logs', fn (Blueprint $table) => $table->index('created_at'));
    }
    ...
    public function down(): void
    {
        ...
        Schema::table('logs', fn (Blueprint $table) => $table->integer('created_at_int')->nullable());
        $this->convert('logs', ['created_at'], static fn ($r) => ['created_at_int' => $toInt($r->created_at)]);
        Schema::table('logs', function (Blueprint $table) {
            $table->dropIndex(['created_at']);
            $table->dropColumn('created_at');
        });
        Schema::table('logs', fn (Blueprint $table) => $table->renameColumn('created_at_int', 'created_at'));
        Schema::table('logs', fn (Blueprint $table) => $table->index('created_at'));
    }
};
