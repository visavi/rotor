...
<?php
    ...
    echo '[ <a href="/rating?uz='.$user['users_login'].'&amp;vote=1"><img src="/images/img/plus.gif" alt="Плюс" /><span style="color:#0099cc"> Плюс</span></a> / ';
    echo '<a href="/rating?uz='.$user['users_login'].'&amp;vote=0"><span style="color:#ff0000">Минус</span> <img src="/images/img/minus.gif" alt="Минус" /></a> ]<br />';
    }
    ...
    echo '<div class="act">';
        echo '<img src="/images/img/wall.gif" alt="Стена" /> <a href="/wall?uz='.$user['users_login'].'">Стена сообщений</a> ('.user_wall($user['users_login']).')<br />';
        ...
        echo '<img src="/images/img/panel.gif" alt="Редактировать" /> <a href="/admin/users?act=edit&amp;uz='.$user['users_login'].'">Редактировать</a><br />';
        }
        } else {
