...
if (is_user()) {
	...
	############################################################################################
		...
		case 'operacia':
			...
			echo '<img src="/images/img/back.gif" alt="image" /> <a href="/games/kredit.php">Вернуться</a><br />';
		break;

	default:
		redirect("/games/kredit.php");
	endswitch;
...
echo '<img src="/images/img/money.gif" alt="image" /> <a href="/games/bank.php">Банк</a><br />';
