    ...
    case 'index':
        ...
        if ($total > 0) {
            ...
            while ($data = $querycomm -> fetch()) {
                ...
                echo '<div class="b"><img src="/images/img/balloon.gif" alt="image" /> <b><a href="/gallery/comments?act=viewcomm&amp;gid='.$data['commphoto_gid'].'&amp;cid='.$data['commphoto_id'].'">'.$data['photo_title'].'</a></b>';
                echo '</div>';
