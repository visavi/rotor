...
if (is_user()) {
  ...
  case "index":
    ...
    echo '<br /><b><a href="bandit.php?act=go">Играть</a></b><br />';

    echo 'В наличии ' . moneys($udata['users_money']) . '<br /><br />';

    echo '<img src="/images/img/faq.gif" alt="image" /> <a href="bandit.php?act=faq">Правила игры</a><br />';
    break;
  # ###########################################################################################
  # #                                           Игра                                         ##
  # ###########################################################################################
  case "go":
    if ($udata['users_money'] >= 5) {
      ...
      echo '<b><a href="bandit.php?act=go&amp;rand=' . $rand . '">Играть</a></b><br />';
    } else {
  ...
  case "faq":
    ...
    echo '<img src="/images/img/back.gif" alt="image" /> <a href="bandit.php">В игру</a><br />';
    break;

  default:
    header("location: /games/bandit.php");
    exit;
    endswitch;
  } else {
