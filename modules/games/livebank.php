...
############################################################################################
    ...
    case 'search':
        ...
        echo '<img src="/images/img/back.gif" alt="image" /> <a href="/games/livebank?start='.$start.'">Вернуться</a><br />';
    break;

endswitch;

echo '<img src="/images/img/money.gif" alt="image" /> <a href="/games/bank">В банк</a><br />';
