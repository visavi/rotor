    ...
    if (!empty($uz)) {
        ...
        if (!empty($user)) {
            ...
            if (empty($user['users_email']) && empty($user['users_secquest'])) {
                echo '<img src="/assets/img/images/error.gif" alt="image" /> <b>Невозможно восстановить пароль!</b><br />';
...
case 'send':
    ...
    if (! empty($user)) {
        ...
        if ($validation->run()) {
            ...
            echo '<img src="/assets/img/images/open.gif" alt="image" /> <b>Восстановление пароля инициализировано!</b><br /><br />';
