...
if (is_admin(array(101, 102, 103))) {
    ...
    ############################################################################################
        case 'index':
            ...
            if (count($votes) > 0) {
                foreach($votes as $valvote) {
                    echo '<div class="b">';
                    echo '<img src="/images/img/stat.gif" alt="image" /> <b><a href="/votes?act=poll&amp;id='.$valvote['vote_id'].'">'.$valvote['vote_title'].'</a></b><br />';
            ...
            echo '<img src="/images/img/stat.gif" alt="image" /> <a href="/admin/votes?act=new">Создать голосование</a><br />';
            echo '<img src="/images/img/luggage.gif" alt="image" /> <a href="/admin/votes?act=history">История голосований</a><br />';
        ...
        case 'add':
            ...
            echo '<img src="/images/img/stat.gif" alt="image" /> <a href="/admin/votes">К голосованиям</a><br />';
        break;
        ...
        case 'history':
            ...
            if ($total > 0) {
                ...
                while ($data = $queryvote -> fetch()) {
                    echo '<div class="b">';
                    echo '<img src="/images/img/luggage.gif" alt="image" /> <b><a href="/votes/history?act=result&amp;id='.$data['vote_id'].'&amp;start='.$start.'">'.$data['vote_title'].'</a></b><br />';
            ...
            echo '<img src="/images/img/stat.gif" alt="image" /> <a href="/admin/votes">Список голосований</a><br />';
        break;
