    ...
    ############################################################################################
        case "index":
            ...
            if (is_admin(array(101)) && $total > 0) {
                echo '<img src="/images/img/error.gif" alt="image" /> <a href="/admin/antimat?act=prodel">Очистить</a><br />';
            }
        break;
        ...
        case "prodel":
            ...
            echo '<img src="/images/img/error.gif" alt="image" /> <b><a href="/admin/antimat?act=clear&amp;uid='.$_SESSION['token'].'">Да уверен!</a></b><br /><br />';
