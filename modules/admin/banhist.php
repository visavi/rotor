...
if (is_admin(array(101, 102, 103))) {
	...
	############################################################################################
		...
		case 'view':
			...
			echo '<i class="fa fa-arrow-circle-left"></i> <a href="banhist.php">Вернуться</a><br />';
		break;
		...
		case 'del':
			...
			echo '<i class="fa fa-arrow-circle-left"></i> <a href="banhist.php?start='.$start.'">Вернуться</a><br />';
		break;
