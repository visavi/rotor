...
mySettings = {
    ...
    markupSet: [
        {title: translate.markitup.bold, name: '<i class="fa fa-bold"></i>', className: 'bb-bold', key: 'B', openWith: '[b]', closeWith: '[/b]'},
        ...
        {separator: '---------------'},
        {title: 'Очистка тегов', name: '<i class="fa fa-eraser"></i>', className: 'bb-clean', replaceWith:function(markitup) { return markitup.selection.replace(/\[(.*?)\]/g, "") } },
