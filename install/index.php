	...
	case '1':
		...
		if (!empty($agree)) {
			...
			if (version_compare(PHP_VERSION, '5.5.9') > 0) {
				echo '<img src="../images/img/plus.gif" alt="image" /> Версия PHP 5.5.9 и выше: <b><span style="color:#00cc00">ОК</span></b> (Версия ' . strtok(phpversion(), '-') . ')<br />';
			} else {
				echo '<img src="../images/img/minus.gif" alt="image" /> Версия PHP 5.5.9 и выше: <b><span style="color:#ff0000">Ошибка</span></b>  (Версия ' . strtok(phpversion(), '-') . ')<br />';
				$error_critical = 1;
			}
