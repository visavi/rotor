...
CREATE TABLE IF NOT EXISTS `commblog` (
  ...
  `commblog_text` text DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `commevents` (
  ...
  `commevent_text` text DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `commload` (
  ...
  `commload_text` text DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `commnews` (
  ...
  `commnews_text` text DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `downs` (
  ...
  `downs_notice` text DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `users_reasonban` text DEFAULT NULL,
