...
return [
    ...
    'step2_install'         => 'Шаг 2 - выполнение миграций (установка)',
    'step3_install'         => 'Шаг 3 - заполнение БД (установка)',
    'step4_install'         => 'Шаг 4 - создание администратора (установка)',
    'step2_update'          => 'Шаг 2 - выполнение миграций (обновление)',
    ...
    'modules_required'      => 'необходимо для установки модулей',
    'mysqlnd_notice'        => 'PDO использует старую libmysqlclient вместо mysqlnd — числа из БД могут приходить строками. Переключите драйвер на mysqlnd (часто в панели хостинга) либо включите DB_NATIVE_TYPES=true в .env',
    'db_connection_failed'  => 'Нет подключения к базе данных, проверьте настройки в .env',
    ...
    'text_message'          => 'Привет, :login! 🎉 Поздравляем — движок Rotor успешно установлен и готов к работе.<br><br>
    Rotor построен на модульной архитектуре: форум, новости, блоги, гостевая книга, доска объявлений, фотогалерея, загрузки и многое другое подключаются как отдельные модули — устанавливайте только то, что действительно нужно вашему сайту.<br><br>
    Свежие версии, обновления, новые модули и темы оформления вы найдёте на нашем сайте <a href="https://visavi.net">visavi.net</a>. Приятной работы!',
    ...
    'update_mode_notice'         => 'Внимание! Вы находитесь в режиме обновления. Будут применены все ожидающие миграции.',
