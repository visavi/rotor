...
return [
    ...
    'send'              => 'Отправить',
    'confirm'           => 'Подтвердить',
    'confirm_complaint' => 'Вы действительно хотите отправить жалобу?',
    ...
    'plus'           => 'Плюс',
    'minus'          => 'Минус',
    'positive_share' => ':share% положительных',
    'who_voted'      => 'Кто голосовал',
    'pluses'         => 'Плюсы',
    'minuses'        => 'Минусы',
    ...
    'messages_published_success' => 'Сообщения успешно опубликованы!',
    'message_publish_moderation' => 'Сообщение будет опубликовано после модерации!',
    ...
    'records_added_success'      => 'Записи успешно добавлены!',
    'record_not_found'           => 'Выбранная запись не найдена!',
    'record_not_active'          => 'Данная запись ещё не проверена модератором!',
