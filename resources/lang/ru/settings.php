...
return [
    ...
    'images_copyright_hint'  => 'Водяной знак берётся из файла:',
    ...
    'registration_email_mode'      => 'Email при регистрации',
    'registration_email_mode_hint' => 'Подтверждение отправляет письмо со ссылкой, до перехода по ней аккаунт ждёт активации',
    'email_mode_hidden'            => 'Не запрашивать',
    'email_mode_optional'          => 'Необязателен',
    'email_mode_required'          => 'Обязателен',
    'email_mode_confirm'           => 'Обязателен с подтверждением',
    ...
    'moneys_hint'     => 'Три формы через запятую: монета,монеты,монет',
    'points_hint'     => 'Три формы через запятую: балл,балла,баллов',
    'extensions_hint' => 'Расширения через запятую, без точки и пробелов',
