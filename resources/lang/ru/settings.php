...
return [
    ...
    'blog_moderation'      => 'Модерация статей пользователей',
    ...
    'images_hint'            => 'При изменении размера превью, необходимо очистить кеш изображений',
    ...
    'offer_title_length' => 'Длина названия предложения',
    'offer_text_length'  => 'Длина текста предложения',
    'offer_reply_length' => 'Длина ответа на предложение',
    ...
    'homepage_view'         => 'Вид главной страницы',
    'homepage_view_classic' => 'Классический вид',
    'homepage_view_feed'    => 'Лента сообщений',
    'feed_topics_show'      => 'Показывать сообщения форума',
    'feed_news_show'        => 'Показывать новости',
    'feed_photos_show'      => 'Показывать фото',
    'feed_articles_show'    => 'Показывать статьи',
    'feed_downs_show'       => 'Показывать загрузки',
    'feed_items_show'       => 'Показывать объявления',
    'feed_offers_show'      => 'Показывать предложения / проблемы',
    'feed_comments_show'    => 'Показывать комментарии',
    'feed_per_page'         => 'Количество постов на страницу',
    'feed_last_record'      => 'Количество получаемых последних записей',
    'feed_total'            => 'Всего постов',
    ...
    'feed_articles_rating'  => 'Скрывать статьи с рейтингом',
    'feed_downs_rating'     => 'Скрывать загрузки с рейтингом',
    'feed_offers_rating'    => 'Скрывать предложения / проблемы с рейтингом',
    'feed_comments_rating'  => 'Скрывать комментарии с рейтингом',

    'invite_days'   => 'Количество дней для получения новых ключей',
    'invite_rating' => 'Рейтинг необходимый для получения ключей',
    'invite_count'  => 'Количество ключей получаемых пользователем',

    'boards_create'         => 'Разрешить пользователям размещение объявлений',
    'boards_period'         => 'Срок размещения объявлений',
    'boards_per_page'       => 'Количество объявлений на страницу',
