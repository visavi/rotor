    ...
    <div class="form">
        <form method="post">
            ...
            <div class="form-group{{ hasError('msg') }}">
                ...
                <textarea class="form-control markItUp" id="msg" rows="5" maxlength="{{ setting('comment_length') }}" data-hint="{{ trans('common.characters_left') }}" name="msg" placeholder="{{ trans('news.message_text') }}" required>{{ getInput('msg', $comment->text) }}</textarea>
