<ul class="list-inline hiding text-left" onclick="return showQueries();">
    ...
    <li class="list-inline-item" data-toggle="tooltip" title="{{ __('index.db_speed') }}"><i class="fas fa-clock"></i> {{ number_format($timeQueries / 1000, 4) }} {{ __('index.seconds') }}</li>
    ...
    <li class="list-inline-item" data-toggle="tooltip" title="{{ __('index.loading_speed') }}"><i class="fas fa-rocket"></i> {{ round(microtime(true) - STARTTIME, 4) }} {{ __('index.seconds') }}</li>
</ul>
