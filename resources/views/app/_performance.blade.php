...
<div class="performance" onclick="return showQueries();" style="cursor: {{ $cursor }}">
    <ul class="list-inline">
        ...
        <li class="list-inline-item" data-bs-toggle="tooltip" title="{{ __('index.loading_speed') }}"><i class="fas fa-rocket"></i> {{ round(microtime(true) - (defined('LARAVEL_START') ? LARAVEL_START : microtime(true)), 3) }} {{ __('index.seconds') }}</li>
    </ul>
