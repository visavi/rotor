                ...
                <div class="b">
                    @if (getUser() && getUser('id') !== $data->user_id)
                        <div class="float-right">
                            ...
                            <a href="#" onclick="return sendComplaint(this)" data-type="{{ App\Models\Guestbook::class }}" data-id="{{ $data->id }}" data-token="{{ $_SESSION['token'] }}" data-page="{{ $page->current }}" rel="nofollow" data-toggle="tooltip" title="{{ __('main.complaint') }}"><i class="fa fa-bell text-muted"></i></a>
                        </div>
                    @endif
