    ...
    <div class="form">
        <form action="/guestbooks/edit/{{ $post->id }}" method="post">
            ...
            <div class="form-group{{ hasError('msg') }}">
                ...
                <textarea class="form-control markItUp" id="msg" rows="5" maxlength="{{ setting('guesttextlength') }}" data-hint="{{ trans('common.characters_left') }}" name="msg" placeholder="{{ trans('guestbooks.message_text') }}" required>{{ getInput('msg', $post->text) }}</textarea>
