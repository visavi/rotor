<div class="section mb-3 shadow">
    ...
    <i class="fa-regular fa-comment"></i> <a href="{{ route('articles.view', ['slug' => $post->slug]) }}#comments">{{ __('main.comments') }}</a> <span class="badge bg-adaptive">{{ $post->count_comments }}</span>
</div>
