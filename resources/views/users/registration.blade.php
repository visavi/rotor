...
@section('content')
    ...
    <div class="mb-3" id="uLogin" data-ulogin="display=panel;fields=first_name,last_name,photo;optional=sex,email,nickname;providers=vkontakte,odnoklassniki,mailru,facebook,google,yandex;redirect_uri={{ siteUrl() }}%2Fregister">
    </div>
