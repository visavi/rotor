    ...
    <div class="form">
        <form action="/messages/send?user={{ $user->login }}" method="post">
            ...
            <div class="form-group{{ hasError('msg') }}">
                ...
                <textarea class="form-control markItUp" maxlength="{{ setting('comment_length') }}" data-hint="{{ trans('common.characters_left') }}" id="msg" rows="5" name="msg" placeholder="Текст сообщения" required>{{ getInput('msg') }}</textarea>
