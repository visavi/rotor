...
@section('content')
    ...
    Напишите об этом <a href="/mails">администратору</a>, <a href="/adminlists">старшим сайта</a> через внутреннюю почту или создавайте тему на форуме где будем вместе обсуждать вопрос, делиться опытом и знаниями<br><br>
