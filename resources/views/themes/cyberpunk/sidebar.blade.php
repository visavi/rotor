...
<aside class="app-sidebar">
    <ul class="app-menu user-menu">
        ...
        @if ($user = getUser())
            ...
            <ul class="treeview-menu">
                ...
                @endif
                <li><a class="treeview-item" href="{{ route('menu') }}" rel="nofollow"><i class="icon fas fa-user-cog"></i> {{ __('index.menu') }}</a></li>
    ...
    <ul class="app-menu">
        ...
        <li class="treeview{{ request()->is('blogs*', 'articles*') ? ' is-expanded' : '' }}">
            <a class="menu-item" href="#" data-bs-toggle="treeview"><i class="menu-icon far fa-sticky-note"></i><span class="menu-label">{{ __('index.blogs') }}</span><i class="treeview-indicator fa fa-angle-down"></i></a>
            <ul class="treeview-menu">
        ...
        <li class="treeview{{ request()->is('loads*', 'downs*') ? ' is-expanded' : '' }}">
            <a class="menu-item" href="#" data-bs-toggle="treeview"><i class="menu-icon fas fa-download"></i><span class="menu-label">{{ __('index.loads') }}</span><i class="treeview-indicator fa fa-angle-down"></i></a>
            <ul class="treeview-menu">
