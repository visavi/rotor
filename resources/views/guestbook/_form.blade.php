    ...
    <div class="section-form mb-3 shadow">
        <form action="{{ route('guestbook.create') }}" method="post">
            ...
            <div class="mb-3{{ hasError('msg') }}">
                ...
                <textarea class="form-control tiptap" maxlength="{{ setting('guestbook_text_max') }}" id="msg" rows="5" name="msg" data-relate-type="{{ \App\Models\Guestbook::$morphName }}" data-relate-id="0" placeholder="{{ __('main.message') }}" required>{{ getInput('msg') }}</textarea>
