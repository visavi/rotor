...
<div class="section mb-3 shadow">
    ...
    <div class="section-body">
        <i class="far fa-circle text-muted"></i> <a href="/users/{{ getUser('login') }}">{{ __('index.my_account') }}</a><br>
        <i class="far fa-circle text-muted"></i> <a href="/profile">{{ __('index.my_profile') }}</a><br>
        <i class="far fa-circle text-muted"></i> <a href="/accounts">{{ __('index.my_details') }}</a><br>
        <i class="far fa-circle text-muted"></i> <a href="/settings">{{ __('index.my_settings') }}</a><br>
        <i class="far fa-circle text-muted"></i> <a href="/socials">{{ __('index.social_networks') }}</a><br>
    </div>
</div>
...
<div class="section mb-3 shadow">
    ...
    <div class="section-body">
        ...
        <i class="far fa-circle text-muted"></i> <a href="/transfers">{{ __('index.money_transfer') }}</a><br>
