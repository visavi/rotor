    ...
    <div class="section-form mb-3 shadow">
        <form action="{{ route('admin.news.create') }}" method="post">
            ...
            <div class="mb-3{{ hasError('text') }}">
                ...
                <textarea class="form-control tiptap" data-relate-type="{{  \App\Models\News::$morphName }}" data-relate-id="0" maxlength="{{ setting('news_text_max') }}" id="text" rows="10" name="text" placeholder="{{ __('main.text') }}" required>{{ getInput('text') }}</textarea>
