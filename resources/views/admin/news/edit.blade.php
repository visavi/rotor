    ...
    <div class="form cut">
        <form action="/admin/news/edit/{{ $news->id }}?page={{ $page }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group{{ hasError('text') }}">
                ...
                <textarea class="form-control markItUp" maxlength="10000" data-hint="{{ trans('common.characters_left') }}" id="text" rows="10" name="text" required>{{ getInput('text', $news->text) }}</textarea>
