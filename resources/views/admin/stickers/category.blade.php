            ...
            <div class="section mb-3 shadow">
                <div class="section-title">
                    ...
                    <div class="float-end">
                        ...
                        <a href="/admin/stickers/sticker/delete/{{ $sticker->id }}?page={{ $stickers->currentPage() }}&amp;token={{ csrf_token() }}" data-bs-toggle="tooltip" title="{{ __('main.delete') }}" onclick="return confirm('{{ __('stickers.confirm_delete_sticker') }}')"><i class="fa fa-times"></i></a>
                    </div>
                </div>
            </div>
        @endforeach
