...
<form method="post">
    ...
    <div class="mb-3{{ hasError('sets[sendprivatmailday]') }}">
        ...
        <input type="number" class="form-control" id="sendprivatmailday" name="sets[sendprivatmailday]" maxlength="2" value="{{ old('sets.sendprivatmailday', $settings['sendprivatmailday']) }}" required>
    ...
    <div class="mb-3{{ hasError('sets[sendmailpacket]') }}">
        ...
        <input type="number" class="form-control" id="sendmailpacket" name="sets[sendmailpacket]" maxlength="3" value="{{ old('sets.sendmailpacket', $settings['sendmailpacket']) }}" required>
