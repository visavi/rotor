...
<form method="post">
    ...
    <div class="mb-3{{ hasError('sets[feed_per_page]') }}">
        ...
        <input type="number" class="form-control" id="feed_per_page" name="sets[feed_per_page]" maxlength="3" value="{{ old('sets.feed_per_page', $settings['feed_per_page']) }}" required>
    ...
    <div class="mb-3{{ hasError('sets[feed_cache_time]') }}">
        ...
        <input type="number" class="form-control" id="feed_cache_time" name="sets[feed_cache_time]" maxlength="5" value="{{ old('sets.feed_cache_time', $settings['feed_cache_time']) }}" required>
    ...
    <div class="mb-3{{ hasError('sets[feed_comments_rating]') }}">
        ...
        <input type="number" class="form-control" id="feed_comments_rating" name="sets[feed_comments_rating]" maxlength="2" value="{{ old('sets.feed_comments_rating', $settings['feed_comments_rating']) }}" required>
