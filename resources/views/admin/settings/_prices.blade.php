...
<form action="/admin/settings?act=prices" method="post">
    ...
    <div class="form-group{{ hasError('sets[sendmoneypoint]') }}">
        <label for="sendmoneypoint">{{ trans('settings.points_transfer') }}:</label>
    ...
    <div class="form-group{{ hasError('sets[editratingpoint]') }}">
        <label for="editratingpoint">{{ trans('settings.points_rating_edit') }}:</label>
    ...
    <div class="form-group{{ hasError('sets[editforumpoint]') }}">
        <label for="editforumpoint">{{ trans('settings.points_topics_edit') }}:</label>
    ...
    <div class="form-group{{ hasError('sets[advertpoint]') }}">
        <label for="advertpoint">{{ trans('settings.points_advert_hide') }}:</label>
    ...
    <div class="form-group{{ hasError('sets[editstatuspoint]') }}">
        <label for="editstatuspoint">{{ trans('settings.points_status_edit') }}:</label>
    ...
    <div class="form-group{{ hasError('sets[editstatusmoney]') }}">
        <label for="editstatusmoney">{{ trans('settings.moneys_status_edit') }}:</label>
    ...
    <div class="form-group{{ hasError('sets[bonusmoney]') }}">
        <label for="bonusmoney">{{ trans('settings.moneys_bonus') }}:</label>
    ...
    <div class="form-group{{ hasError('sets[registermoney]') }}">
        <label for="registermoney">{{ trans('settings.moneys_registration') }}:</label>
