...
<form action="/admin/settings?act=guestbooks" method="post">
    ...
    <div class="custom-control custom-checkbox">
        ...
        <label class="custom-control-label" for="bookadds">{{ trans('settings.guestbooks_guests_allow') }}</label>
    </div>
    ...
    <div class="custom-control custom-checkbox">
        ...
        <label class="custom-control-label" for="bookscores">{{ trans('settings.guestbooks_points_add') }}</label>
    </div>

    <div class="form-group{{ hasError('sets[bookpost]') }}">
        <label for="bookpost">{{ trans('settings.guestbooks_per_page') }}:</label>
    ...
    <div class="form-group{{ hasError('sets[guesttextlength]') }}">
        <label for="guesttextlength">{{ trans('settings.guestbooks_symbols') }}:</label>
