...
<form action="/admin/settings?act=contacts" method="post">
    ...
    <div class="form-group{{ hasError('sets[contactlist]') }}">
        <label for="contactlist">{{ trans('settings.contacts_per_page') }}:</label>
    ...
    <div class="form-group{{ hasError('sets[ignorlist]') }}">
        <label for="ignorlist">{{ trans('settings.ignores_per_page') }}:</label>
    ...
    <div class="form-group{{ hasError('sets[limitcontact]') }}">
        <label for="limitcontact">{{ trans('settings.contacts_max_users') }}:</label>
    ...
    <div class="form-group{{ hasError('sets[limitignore]') }}">
        <label for="limitignore">{{ trans('settings.ignores_max_users') }}:</label>
