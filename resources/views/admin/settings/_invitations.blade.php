...
<form method="post">
    ...
    <div class="mb-3{{ hasError('sets[invite_days]') }}">
        ...
        <input type="number" class="form-control" id="invite_days" name="sets[invite_days]" maxlength="3" value="{{ getInput('sets.invite_days', $settings['invite_days']) }}" required>
    ...
    <div class="mb-3{{ hasError('sets[invite_rating]') }}">
        ...
        <input type="number" class="form-control" id="invite_rating" name="sets[invite_rating]" maxlength="3" value="{{ getInput('sets.invite_rating', $settings['invite_rating']) }}" required>
    ...
    <div class="mb-3{{ hasError('sets[invite_count]') }}">
        ...
        <input type="number" class="form-control" id="invite_count" name="sets[invite_count]" maxlength="3" value="{{ getInput('sets.invite_count', $settings['invite_count']) }}" required>
