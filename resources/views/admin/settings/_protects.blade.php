...
<form method="post">
    @csrf
    <?php $inputCaptcha = old('sets.captcha_type', $settings['captcha_type']); ?>
    ...
    <div class="mb-3{{ hasError('sets[captcha_symbols]') }}">
        ...
        <input pattern="[a-z0-9]+" type="text" class="form-control" id="captcha_symbols" name="sets[captcha_symbols]" maxlength="36" value="{{ old('sets.captcha_symbols', $settings['captcha_symbols']) }}" required>
    ...
    <div class="mb-3{{ hasError('sets[captcha_maxlength]') }}">
        ...
        <input type="number" min="4" max="8" class="form-control" id="captcha_maxlength" name="sets[captcha_maxlength]" maxlength="1" value="{{ old('sets.captcha_maxlength', $settings['captcha_maxlength']) }}" required>
    ...
    <div class="mb-3{{ hasError('sets[recaptcha_public]') }}">
        ...
        <input type="text" class="form-control" id="recaptcha_public" name="sets[recaptcha_public]" value="{{ old('sets.recaptcha_public', $settings['recaptcha_public']) }}">
    ...
    <div class="mb-3{{ hasError('sets[recaptcha_private]') }}">
        ...
        <input type="text" class="form-control" id="recaptcha_private" name="sets[recaptcha_private]" value="{{ old('sets.recaptcha_private', $settings['recaptcha_private']) }}">
