...
<form action="/admin/settings?act=loads" method="post">
    ...
    <div class="form-group{{ hasError('sets[maxfiles]') }}">
        <label for="maxfiles">{{ trans('settings.loads_max_files') }}:</label>
    ...
    <div class="form-group{{ hasError('sets[downlist]') }}">
        <label for="downlist">{{ trans('settings.loads_per_page') }}:</label>
    ...
    <div class="form-group{{ hasError('sets[downcomm]') }}">
        <label for="downcomm">{{ trans('settings.loads_comments') }}:</label>
    ...
    <div class="form-group{{ hasError('sets[ziplist]') }}">
        <label for="ziplist">{{ trans('settings.loads_archives') }}:</label>
    ...
    <div class="form-group{{ hasError('sets[fileupload]') }}">
        <label for="fileupload">{{ trans('main.max_file_weight') }} (Mb):</label>
    ...
    <div class="form-group{{ hasError('sets[allowextload]') }}">
        <label for="allowextload">{{ trans('main.valid_file_extensions') }}:</label>
    ...
    <div class="custom-control custom-checkbox">
        ...
        <label class="custom-control-label" for="downupload">{{ trans('settings.loads_files_allow') }}</label>
    </div>
