...
<form method="post">
    ...
    <div class="mb-3{{ hasError('sets[stickermaxsize]') }}">
        ...
        <input type="number" class="form-control" id="stickermaxsize" name="sets[stickermaxsize]" maxlength="3" value="{{ old('sets.stickermaxsize', round($settings['stickermaxsize'] / 1024)) }}" required>
    ...
    <div class="mb-3{{ hasError('sets[stickerminweight]') }}">
        ...
        <input type="number" class="form-control" id="stickerminweight" name="sets[stickerminweight]" maxlength="3" value="{{ old('sets.stickerminweight', $settings['stickerminweight']) }}" required>
    ...
    <div class="mb-3{{ hasError('sets[stickermaxweight]') }}">
        ...
        <input type="number" class="form-control" id="stickermaxweight" name="sets[stickermaxweight]" maxlength="3" value="{{ old('sets.stickermaxweight', $settings['stickermaxweight']) }}" required>
    ...
    <div class="mb-3{{ hasError('sets[stickerlist]') }}">
        ...
        <input type="number" class="form-control" id="stickerlist" name="sets[stickerlist]" maxlength="2" value="{{ old('sets.stickerlist', $settings['stickerlist']) }}" required>
