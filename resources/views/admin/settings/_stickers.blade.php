...
<form action="/admin/settings?act=stickers" method="post">
    ...
    <div class="form-group{{ hasError('sets[stickermaxsize]') }}">
        <label for="stickermaxsize">{{ trans('settings.stickers_size') }} (kb):</label>
    ...
    <div class="form-group{{ hasError('sets[stickermaxweight]') }}">
        <label for="stickermaxweight">{{ trans('settings.stickers_max_weight') }} (px):</label>
    ...
    <div class="form-group{{ hasError('sets[stickerminweight]') }}">
        <label for="stickerminweight">{{ trans('settings.stickers_min_weight') }} (px):</label>
    ...
    <div class="form-group{{ hasError('sets[stickerlist]') }}">
        <label for="stickerlist">{{ trans('settings.stickers_per_page') }}:</label>
