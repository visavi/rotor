...
<form method="post">
    ...
    <div class="mb-3{{ hasError('sets[privatpost]') }}">
        ...
        <input type="number" class="form-control" id="privatpost" name="sets[privatpost]" maxlength="2" value="{{ old('sets.privatpost', $settings['privatpost']) }}" required>
    ...
    <div class="mb-3{{ hasError('sets[privatprotect]') }}">
        ...
        <input type="number" class="form-control" id="privatprotect" name="sets[privatprotect]" maxlength="4" value="{{ old('sets.privatprotect', $settings['privatprotect']) }}" required>
