...
<form action="/admin/settings?act=forums" method="post">
    ...
    <div class="form-group{{ hasError('sets[forumpost]') }}">
        <label for="forumpost">{{ trans('settings.posts_per_page') }}:</label>
    ...
    <div class="form-group{{ hasError('sets[forumtextlength]') }}">
        <label for="forumtextlength">{{ trans('settings.posts_symbols') }}:</label>
    ...
    <div class="form-group{{ hasError('sets[forumloadsize]') }}">
        <label for="forumloadsize">{{ trans('main.max_file_weight') }} (Mb):</label>
    ...
    <div class="form-group{{ hasError('sets[forumextload]') }}">
        <label for="forumextload">{{ trans('main.valid_file_extensions') }}:</label>
    ...
    <div class="form-group{{ hasError('sets[forumloadpoints]') }}">
        <label for="forumloadpoints">{{ trans('settings.forums_upload_points') }}:</label>
