            ...
            <div class="section mb-3 shadow">
                <div class="section-header d-flex align-items-center">
                    ...
                    <div class="text-end">
                        ...
                        <a href="/admin/articles/delete/{{ $article->id }}?page={{ $articles->currentPage() }}&amp;token={{ csrf_token() }}" onclick="return confirm('{{ __('blogs.confirm_delete_article') }}')" title="{{ __('main.delete') }}"><i class="fa fa-times text-muted"></i></a>
                    </div>
                </div>
