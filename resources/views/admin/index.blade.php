...
@section('content')
    ...
    <div class="section mb-3 shadow">
        ...
        <div class="section-body">
            ...
            <i class="far fa-circle text-muted"></i> <a href="{{ route('admin.blogs.index') }}">{{ __('index.blogs') }}</a> <span class="badge bg-adaptive">{{ statsBlog() }}</span><br>
            <i class="far fa-circle text-muted"></i> <a href="{{ route('admin.articles.new') }}">{{ __('index.new_articles') }}</a> <span class="badge bg-adaptive">{{ statsNewArticles() }}</span><br>
            <i class="far fa-circle text-muted"></i> <a href="{{ route('admin.boards.index') }}">{{ __('index.boards') }}</a> <span class="badge bg-adaptive">{{ statsBoard() }}</span><br>
    ...
    @if (isAdmin('moder'))
        <div class="section mb-3 shadow">
            ...
            <div class="section-body">
                ...
                <i class="far fa-circle text-muted"></i> <a href="{{ route('admin.votes.index') }}">{{ __('index.votes') }}</a> <span class="badge bg-adaptive">{{ statVotes() }}</span><br>
    ...
    @if (isAdmin('admin'))
        <div class="section mb-3 shadow">
            ...
            <div class="section-body">
                ...
                <i class="far fa-circle text-muted"></i> <a href="{{ route('admin.loads.index') }}">{{ __('index.loads') }}</a> <span class="badge bg-adaptive">{{ statsLoad() }}</span><br>
                <i class="far fa-circle text-muted"></i> <a href="{{ route('admin.downs.new') }}">{{ __('index.new_loads') }}</a> <span class="badge bg-adaptive">{{ statsNewLoad() }}</span><br>
